...
def test_read_post_with_nonexisting_valid_id(client: TestClient) -> None:
    nonexisting_valid_id = "63df3284-94fe-42e2-be37-dfc6d38f374e"
    r = client.get(f"/posts/{nonexisting_valid_id}")
...
def test_update_post_with_nonexisting_valid_id(
    client: TestClient,
    token_headers: Headers,
) -> None:
    nonexisting_valid_id = "63df3284-94fe-42e2-be37-dfc6d38f374e"
    r = client.put(
        f"/posts/{nonexisting_valid_id}",
        headers=token_headers,
...
def test_delete_post_with_nonexisting_valid_id(
    client: TestClient,
    token_headers: Headers,
) -> None:
    nonexisting_valid_id = "63df3284-94fe-42e2-be37-dfc6d38f374e"
    r = client.delete(f"/posts/{nonexisting_valid_id}", headers=token_headers)
    assert r.status_code == status.HTTP_404_NOT_FOUND
